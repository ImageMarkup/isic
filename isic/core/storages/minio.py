...
from minio_storage import MinioMediaStorage, MinioStorage
...
class PreventRenamingMinioStorage(PreventRenamingMixin, MinioStorage):
    pass


class MinioS3ProxyStorage(MinioStorage):
    """
