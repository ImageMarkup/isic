...
def test_utils_zip_file_names_in_zip(zip_stream_only_images):
    file_names = file_names_in_zip(zip_stream_only_images)
...
def test_utils_zip_items_in_zip(zip_stream_only_images):
    zip_items = items_in_zip(zip_stream_only_images)

    zip_items_list = list(zip_items)
    assert len(zip_items_list) == 5


def test_utils_zip_items_in_zip_item(zip_stream_only_images):
    zip_items = items_in_zip(zip_stream_only_images)
...
def test_utils_zip_items_in_zip_read(zip_stream_only_images):
    zip_items = items_in_zip(zip_stream_only_images)
    zip_item = next(zip_items)
