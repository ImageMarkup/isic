...
def accession_reprocess(*, accession: Accession) -> None:
    ...
    # accession points to non-existent blobs. no data is lost since we can always regenerate
    ...
    with transaction.atomic():
        # only the sponsored blob fields need to be cleared here, since the other fields are
