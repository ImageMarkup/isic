...
MIDDLEWARE = [
    ...
    # "UserTypeTagMiddleware" does nothing for incoming requests, but adds user-based tags to
    # outgoing response objects, so run this after (on responses) "SessionMiddleware" has completed,
    # in case that does anything to the current user.
