...
from resonant_settings.production.email import *  # noqa: E402,I001
from resonant_settings.production.https import *  # noqa: E402,I001
...
from resonant_settings.production.s3_storage import *  # noqa: E402,I001
STORAGES.update(
    {
        "default": {
            ...
            "OPTIONS": {
                ...
                "custom_domain": env.str("DJANGO_ISIC_STORAGE_CUSTOM_DOMAIN"),
                "cloudfront_key_id": env.str("DJANGO_ISIC_STORAGE_CLOUDFRONT_KEY_ID"),
                "cloudfront_key": env.str("DJANGO_ISIC_STORAGE_CLOUDFRONT_KEY"),
            },
        },
        "sponsored": {
