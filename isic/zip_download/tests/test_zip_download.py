...
def test_zip_download_listing_urls(authenticated_client, zip_basic_auth, image_factory, user):
    ...
    expected_public_url = f"{sponsored_url_prefix}/{public_image.accession.sponsored_blob}"
    expected_private_url = f"{default_url_prefix}/{private_image.accession.blob}"
